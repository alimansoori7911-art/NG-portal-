...
const schema = z.object({
    ...
    /* همان الگوی ورود و ثبت‌نام: پروفایل شماره را به شکل +98... برمی‌گرداند
       و فرم از روی پروفایل پیش‌پر می‌شود، پس الگوی فقط-۰۹ دکمه را برای
       همه‌ی کاربرها غیرفعال می‌کرد بدون اینکه خطایی نشان دهد. */
    phone: z
        .string()
